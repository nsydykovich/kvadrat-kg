			...
			<div className={'text-center'}>
				...
				<div className={'mt-10 flex items-center justify-center gap-x-6'}>
					<Link
						...
						className={
							'text-foreground rounded-md bg-red-500 px-3.5 py-2.5 text-sm font-semibold shadow-xs hover:bg-red-400 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-500'
						}
					>
						Главная страница
					</Link>
